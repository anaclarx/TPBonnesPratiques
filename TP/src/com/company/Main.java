...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        RequestHandler request1 = new ExistingContentRequestHandler();
        RequestHandler request2 = new PolicyCheckRequestHandler();
        RequestHandler request3 = new RenderContentHandler();

        request1.setSuccessor(request2);
        request2.setSuccessor(request3);

        WebServer webServer = new WebServer(request1);
